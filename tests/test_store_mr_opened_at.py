...
def _row(**over):
    base = dict(id=1, project_path="audacy-inc/devops/x", iid=7,
                ...
                merged_by="", fetched_at=datetime(2026, 7, 22, 16, 0, 0), events_fetched_at=datetime(2026, 7, 22, 16, 0, 0),
                description="", source_branch="",
                pipelines_fetched_at=datetime(2026, 7, 22, 16, 0, 0), author_name=None)
    base.update(over)
